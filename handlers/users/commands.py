...
async def introduction_command(message: Message):
    ...
    await bot.send_photo(caption=answer, photo=open('assets/logo.jpg', 'rb'), reply_markup=main_menu.main_menu,
...
async def help_command(message: Message):
    ...
    await bot.send_animation(caption=first, animation=open('assets/help.gif', 'rb'), chat_id=message.from_user.id)
